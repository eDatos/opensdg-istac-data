...
formula_teorica: '$$PG_{salud}^{t} = \frac{G_{salud}^{t}}{G^{t}} \cdot 100$$ <br>
donde: <br>
$G_{salud}^{t} =$ gasto de las administraciones públicas autonómicas que se dedica a salud (grupo funcional 07 de la Classifications of the Functions of Government (COFOG)) en el año $t$ <br>
